...
curl -X POST $API/propertykeys $HEADERS -d '{"name": "caller_id", "data_type": "TEXT", "cardinality": "SINGLE"}'
...
curl -X POST $API/vertexlabels $HEADERS -d '{
  "name": "call_event",
  "properties": ["id", "caller_id", "target_id", "timestamp", "duration", "location_id"],
